            ...
            with self.subTest(build=label):
                ...
                with tempfile.TemporaryDirectory() as folder:
                    ...
                    result = subprocess.run([sys.executable, "-I", "-c",
                        "import sys; sys.path.insert(0, sys.argv[1]); import simpleoffice_network_gateway_runtime; import simpleoffice_mini_control; import simpleoffice_service_lifecycle; import simpleoffice_sip_runtime; import simpleoffice_connection_relay", folder],
