...
UI_LITERAL_TRANSLATIONS = {
    "en": {
        ...
        "Kontakte": "Contacts", "Kontaktliste": "Contact list", "Kontakt anlegen": "Create contact", "Kontaktdaten bearbeiten": "Edit contact details", "Änderungen speichern": "Save changes", "Änderungsverlauf": "Change history", "Gemeinsame Verwaltung": "Shared management", "Freigaben speichern": "Save sharing", "Eigentümer:": "Owner:", "Adressen": "Addresses", "Adresse": "Address", "Anzeigename": "Display name", "Vorname": "First name", "Nachname": "Last name", "Firma": "Company", "Geburtstag": "Birthday", "Telefon": "Phone", "vCard exportieren": "Export vCard", "vCard importieren": "Import vCard", "Kontakt gespeichert.": "Contact saved.",
