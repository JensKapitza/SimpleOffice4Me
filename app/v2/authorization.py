...
class AuthorizationStore:
    ...
    def issue_root(self, *, issuer: str, subject: str, rights: Iterable[GrantRight | str],
                   object_refs: Iterable[str], expires_at: int) -> CapabilityGrant:
    ...
    def delegate(self, parent_grant_id: str, *, issuer: str, subject: str,
                 rights: Iterable[GrantRight | str], object_refs: Iterable[str],
                 expires_at: int, allow_redelegation: bool = False) -> CapabilityGrant:
    ...
    def allows(self, grant_id: str, *, subject: str, right: GrantRight,
               object_ref: str, now: int | None = None) -> bool:
