"""Stable application/build identity for UI, diagnostics and offline updates."""
...
def build_info(root: str | Path | None = None) -> dict[str, Any]:
    ...
    # Prefer the code-derived commit count so source checkouts and offline
    # release manifests describe a build the same way. CI may explicitly
    # override it for packaged artifacts.
