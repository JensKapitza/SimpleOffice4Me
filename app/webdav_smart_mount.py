...
def smart_mount(username: str, relative: str):
    ...
    # Delegate to the normal hierarchical WebDAV endpoint using the original
    # path.  This preserves ACL checks, ETags, locks, revisions, trash, quota,
    # integrity validation and malware scanning instead of reimplementing them.
