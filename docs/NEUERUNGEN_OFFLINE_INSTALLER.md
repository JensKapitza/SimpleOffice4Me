...
- zentrale Admin-Konfiguration für GitHub-Quelle und Zugriff
- verschlüsselte Speicherung der administrativen Zugriffsinformation
...
- die GitHub-Quelle konfigurieren
...
Die administrativen Zugriffsinformationen werden nicht im Klartext an die Oberfläche zurückgegeben. Vorhandene Environment-Konfiguration kann als Kompatibilitätsweg übernommen werden; nach einer bewussten Admin-Speicherung ist die zentrale Konfiguration maßgeblich.
...
- verschlüsselte Admin-Konfiguration und Migration vorhandener Einstellungen
...
| zentrale Admin-Konfiguration | weniger verstreute Betriebsparameter |
| verschlüsselte Ablage | administrative Zugriffsinformation bleibt geschützt |
